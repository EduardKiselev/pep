...
urlpatterns = [
    ...
    path('ration_detail/<int:ration_id>', views.RationDetailView.as_view(), name='ration_detail'),
    path('ration_delete/<int:ration_id>', views.RationDeleteView.as_view(), name='ration_delete'),
]
